...
<head>
    ...
    <title>@yield('title', 'Wurger - Sistema de Gestión')</title>
    ...
    <div class="sidebar" id="sidebar">
        ...
        <nav class="sidebar-nav">
            ...
            @if(auth()->user()->rol === 'Administrador')
                ...
                <div class="nav-item">
                    <a href="{{ route('busqueda.index') }}" class="nav-link {{ request()->routeIs('busqueda.*') ? 'active' : '' }}">
            ...
            @else
                <div class="nav-item">
                    <a href="{{ route('user.productos.index') }}" class="nav-link {{ request()->routeIs('user.productos.*') ? 'active' : '' }}">
                        <i class="fas fa-box"></i>
                        <span>Productos</span>
                    </a>
                </div>
                ...
                <div class="nav-item">
                    <a href="{{ route('user.pedidos.index') }}" class="nav-link {{ request()->routeIs('user.pedidos.*') ? 'active' : '' }}">
    ...
    <div class="main-content" id="mainContent">
        <div class="top-bar">
            ...
            <div class="top-bar-right">
                <div class="user-info">
                    <span class="user-name">{{ auth()->user()->usuarioInfo->nombre ?? auth()->user()->email }}</span>
