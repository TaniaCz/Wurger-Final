...
<body>
    ...
    <nav class="navbar">
        ...
        <ul class="nav-links">
            ...
            <li><a href="{{ route('login') }}"><button class="btn-login">Iniciar Sesión</button></a></li>
        </ul>
    ...
    <section id="menu" class="animate-fade">
        ...
        <div class="menu-container">
            ...
            <div class="menu-item">
                <img src="{{ asset('img/ham-2.jpg') }}" alt="Hamburguesa con bacon crujiente">
                <h3>Bacon XL</h3>
                <p>Doble carne, bacon crocante, cebolla caramelizada y salsa BBQ</p>
                <span class="price">$15.99</span>
            </div>
            <div class="menu-item">
                <img src="{{ asset('img/ham-3.jpg') }}" alt="Hamburguesa vegetariana saludable">
                <h3>Vegetariana</h3>
                <p>NotBurger de garbanzos, aguacate, rúcula y tomate seco</p>
                <span class="price">$13.99</span>
            </div>
            <div class="menu-item">
                <img src="{{ asset('img/ham-4.jpg') }}" alt="Hamburguesa picante con jalapeños">
    ...
    <section id="nosotros" class="animate-fade">
        ...
        <div style="max-width: 800px; margin: 0 auto; text-align: center;">
            ...
            <p>¿Eres administrador? <a href="{{ route('login') }}" style="color: var(--primary-color); text-decoration: none; font-weight: 600;">Inicia sesión aquí</a> para acceder al sistema de gestión.</p>
        </div>
    </section>
