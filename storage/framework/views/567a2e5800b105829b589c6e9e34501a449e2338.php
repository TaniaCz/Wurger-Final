...
<body>
    ...
    <nav class="navbar">
        ...
        <ul class="nav-links">
            ...
            <li><a href="<?php echo e(route('login')); ?>"><button class="btn-login">Iniciar Sesión</button></a></li>
        </ul>
    ...
    <section id="menu" class="animate-fade">
        ...
        <div class="menu-container">
            <div class="menu-item">
                <img src="<?php echo e(asset('img/ham-1.jpg')); ?>" alt="Hamburguesa Clásica con queso y vegetales frescos">
                <h3>Clásica</h3>
                <p>Carne 200g, queso cheddar, lechuga, tomate y salsa especial</p>
                <span class="price">$12.99</span>
            </div>
            <div class="menu-item">
                <img src="<?php echo e(asset('img/ham-2.jpg')); ?>" alt="Hamburguesa con bacon crujiente">
                <h3>Bacon XL</h3>
                <p>Doble carne, bacon crocante, cebolla caramelizada y salsa BBQ</p>
                <span class="price">$15.99</span>
            </div>
            <div class="menu-item">
                <img src="<?php echo e(asset('img/ham-3.jpg')); ?>" alt="Hamburguesa vegetariana saludable">
                <h3>Vegetariana</h3>
                <p>NotBurger de garbanzos, aguacate, rúcula y tomate seco</p>
                <span class="price">$13.99</span>
            </div>
            <div class="menu-item">
                <img src="<?php echo e(asset('img/ham-4.jpg')); ?>" alt="Hamburguesa picante con jalapeños">
    ...
    <section id="nosotros" class="animate-fade">
        ...
        <div style="max-width: 800px; margin: 0 auto; text-align: center;">
            ...
            <p>¿Eres administrador? <a href="<?php echo e(route('login')); ?>" style="color: var(--primary-color); text-decoration: none; font-weight: 600;">Inicia sesión aquí</a> para acceder al sistema de gestión.</p>
        </div>
    </section>
...
<?php /**PATH C:\Users\usuario\OneDrive\Escritorio\Wurger-Final\resources\views/home/index.blade.php ENDPATH**/ ?>